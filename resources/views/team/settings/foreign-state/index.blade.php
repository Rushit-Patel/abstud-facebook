...
$breadcrumbs = [
    ...
    ['title' => 'Foreign State Management']
];
@endphp
...
<x-team.layout.app title="Foreign State Management" :breadcrumbs="$breadcrumbs">
    <x-slot name="content">
        <div class="kt-container-fixed">
            <div class="flex flex-wrap items-center lg:items-end justify-between gap-5 pb-7.5">
                <div class="flex flex-col justify-center gap-2">
                    <h1 class="text-xl font-medium leading-none text-mono">
                        Foreign State Management
                    </h1>
                    <div class="flex items-center gap-2 text-sm font-normal text-secondary-foreground">
                        Manage foreign state and their status configurations
                    </div>
                </div>
                <div class="flex items-center gap-2.5">
                    <a href="{{ route('team.settings.foreign-state.create') }}" class="kt-btn kt-btn-primary">
            ...
            <x-team.card title="Foreign State List" headerClass="">
        ...
        <!-- Delete Modal -->
         ...
         <div id="deleteModal" class="fixed inset-0 z-50 hidden flex items-center justify-center backdrop-blur-sm bg-opacity-50">
            <div class="bg-white rounded-lg p-6 w-full max-w-md shadow-lg border border-gray-300">
                <h2 class="text-lg font-semibold mb-4">Delete Foreign State</h2>
                <p class="mb-6">Are you sure you want to delete this Foreign State?</p>

                <form id="deleteForm" action="{{ route('team.settings.foreign-state.destroy', '__id__') }}" method="POST">
                    @csrf
                    @method('DELETE')
