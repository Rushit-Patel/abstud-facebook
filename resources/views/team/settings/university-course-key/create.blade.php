...
$breadcrumbs = [
    ...
    ['title' => 'Create University Course Key']
];
@endphp

<x-team.layout.app title="Create University Course Key" :breadcrumbs="$breadcrumbs">
    <x-slot name="content">
        <div class="kt-container-fixed">
            <div class="flex flex-wrap items-center lg:items-end justify-between gap-5 pb-7.5">
                <div class="flex flex-col justify-center gap-2">
                    <h1 class="text-xl font-medium leading-none text-mono">
                        Create New University Course Key
                    </h1>
                    <div class="flex items-center gap-2 text-sm font-normal text-secondary-foreground">
                        Add a new university-course-key to the system
                    </div>
                </div>
            ...
            <x-team.card title="University Course Key Information" headerClass="">
                <form action="{{ route('team.settings.university-course-key.store') }}" method="POST" class="form">
                    @csrf
