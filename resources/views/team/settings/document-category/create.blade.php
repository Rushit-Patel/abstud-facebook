...
<x-team.layout.app title="Create Document Category" :breadcrumbs="$breadcrumbs">
    <x-slot name="content">
        <div class="kt-container-fixed">
            ...
            <x-team.card title="Document Category Information" headerClass="">
                <form action="{{ route('team.settings.document-category.store') }}" method="POST" class="form">
                    @csrf
