...
@endpush
<x-team.layout.app title="State Management" :breadcrumbs="$breadcrumbs">
    <x-slot name="content">
        <div class="kt-container-fixed">
            <div class="flex flex-wrap items-center lg:items-end justify-between gap-5 pb-7.5">
                ...
                <div class="flex items-center gap-2.5">
                    <a href="{{ route('team.settings.states.create') }}" class="kt-btn kt-btn-primary">
             ...
             <x-team.card title="State List" headerClass="">
