...
$breadcrumbs = [
    ...
    ['title' => 'Create Exam Mode']
];
@endphp

<x-team.layout.app title="Create Exam Mode" :breadcrumbs="$breadcrumbs">
    <x-slot name="content">
        <div class="kt-container-fixed">
            <div class="flex flex-wrap items-center lg:items-end justify-between gap-5 pb-7.5">
                <div class="flex flex-col justify-center gap-2">
                    ...
                    <div class="flex items-center gap-2 text-sm font-normal text-secondary-foreground">
                        Add a new exam-mode to the system
                    </div>
                </div>
            ...
            <x-team.card title="Exam Mode Information" headerClass="">
                <form action="{{ route('team.settings.exam-mode.store') }}" method="POST" class="form">
                    @csrf
