...
<x-team.layout.app title="Create Task Category" :breadcrumbs="$breadcrumbs">
    <x-slot name="content">
        <div class="kt-container-fixed">
            <div class="flex flex-wrap items-center lg:items-end justify-between gap-5 pb-7.5">
                <div class="flex flex-col justify-center gap-2">
                    ...
                    <div class="flex items-center gap-2 text-sm font-normal text-secondary-foreground">
                        Add a new task-category to the system
                    </div>
                </div>
            ...
            <x-team.card title="Task Category Information" headerClass="">
                <form action="{{ route('team.settings.task-category.store') }}" method="POST" class="form">
                    @csrf
