...
<x-team.layout.app title="University Management" :breadcrumbs="$breadcrumbs">
    <x-slot name="content">
        <div class="kt-container-fixed">
            <div class="flex flex-wrap items-center lg:items-end justify-between gap-5 pb-7.5">
                <div class="flex flex-col justify-center gap-2">
                    ...
                    <div class="flex items-center gap-2 text-sm font-normal text-secondary-foreground">
                        Manage University and their status configurations
                    </div>
                </div>
                <div class="flex items-center gap-2.5">
                    <a href="{{ route('team.settings.university.create') }}" class="kt-btn kt-btn-primary">
            ...
            <x-team.card title="University List" headerClass="">
        ...
        <!-- Delete Modal -->
         ...
         <div id="deleteModal" class="fixed inset-0 z-50 hidden flex items-center justify-center backdrop-blur-sm bg-opacity-50">
            <div class="bg-white rounded-lg p-6 w-full max-w-md shadow-lg border border-gray-300">
                <h2 class="text-lg font-semibold mb-4">Delete University</h2>
                <p class="mb-6">Are you sure you want to delete this University?</p>

                <form id="deleteForm" action="{{ route('team.settings.university.destroy', '__id__') }}" method="POST">
                    @csrf
                    @method('DELETE')
