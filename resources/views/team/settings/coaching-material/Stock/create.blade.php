...
$breadcrumbs = [
    ...
    ['title' => 'Create Coaching Material Stock']
];
@endphp

<x-team.layout.app title="Create Coaching Material Stock" :breadcrumbs="$breadcrumbs">
    <x-slot name="content">
        <div class="kt-container-fixed">
            <div class="flex flex-wrap items-center lg:items-end justify-between gap-5 pb-7.5">
                <div class="flex flex-col justify-center gap-2">
                    <h1 class="text-xl font-medium leading-none text-mono">
                        Create New Coaching Material Stock
                    </h1>
                    <div class="flex items-center gap-2 text-sm font-normal text-secondary-foreground">
                        Add a new coaching-material-stock to the system
                    </div>
                </div>
            ...
            <x-team.card title="Coaching Material Stock Information" headerClass="">
                <form action="{{ route('team.settings.coaching-material.stock.store' ,$id) }}" method="POST" class="form">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="grid grid-cols-1 {{ $gridCols }} gap-5 py-5">
                            ...
                            <div>
                                <x-team.forms.datepicker
                                        ...
                                        required="true"
                                        dateFormat="Y-m-d"
                                        :value="old('stock_date', \Carbon\Carbon::today()->format('d/m/Y'))"
                    ...
                    <div class="flex justify-end gap-2.5 pt-5 border-t border-gray-200">
                        ...
                        <button type="submit" class="kt-btn kt-btn-primary">
                            ...
                            Create Coaching Material Stock
                        </button>
                    </div>
                </form>
            </x-team.card>
