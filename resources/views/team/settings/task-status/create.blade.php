...
<x-team.layout.app title="Create Task Status" :breadcrumbs="$breadcrumbs">
    <x-slot name="content">
        <div class="kt-container-fixed">
            ...
            <x-team.card title="Task Status Information" headerClass="">
                <form action="{{ route('team.settings.task-status.store') }}" method="POST" class="form">
                    @csrf
