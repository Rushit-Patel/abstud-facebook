...
<x-team.layout.app title="Edit Campus" :breadcrumbs="$breadcrumbs">
    <x-slot name="content">
        <div class="kt-container-fixed">
            ...
            <x-team.card title="Campus Information" headerClass="">
                <form action="{{ route('team.settings.campus.update', $campus) }}" method="POST" class="form">
                    @csrf
                    @method('PUT')
                            ...
                            <x-team.card title="Basic Information">
                                <div class="grid grid-cols-2 gap-5">
                                    ...
                                    <x-team.forms.select
                                        ...
                                        :selected="old('f_country_id' ,$campus?->f_country_id)"
                                        searchable="true"
                                        required />
                                    ...
                                    <x-team.forms.select
                                        ...
                                        data-selected="{{ old('f_state_id', $campus?->f_state_id) }}"
                                        searchable="true"
                                        required />
                                    ...
                                    <x-team.forms.select
                                        ...
                                        :selected="old('f_city_id' ,$campus?->f_city_id)"
                                        searchable="true"
                                        data-selected="{{ old('f_city_id', $campus?->f_city_id) }}"
                                        required />
                                </div>
                            </x-team.card>
                        </div>
                                ...
                                <div class="flex flex-col gap-1 mt-4">
                                    ...
                                    <label class="kt-label">
                                        <input class="kt-checkbox kt-checkbox-sm"
                                            ...
                                            type="checkbox"
                                            value="1"
                                            {{ old('status', $campus->status) ? 'checked' : '' }}
                                        />
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-5 py-5 border-t border-gray-200">
                        <div class="flex flex-col gap-2.5">
                            ...
                            <div class="text-sm text-gray-700">
                                {{ $campus->created_at->format('M d, Y \a\t h:i A') }}
                            </div>
                        </div>
                        ...
                        <div class="flex flex-col gap-2.5">
                            ...
                            <div class="text-sm text-gray-700">
                                {{ $campus->updated_at->format('M d, Y \a\t h:i A') }}
                            </div>
                        </div>
                    </div>
