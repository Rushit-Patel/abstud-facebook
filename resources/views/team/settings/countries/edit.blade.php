...
<x-team.layout.app title="Edit Country" :breadcrumbs="$breadcrumbs">
    <x-slot name="content">
        <div class="kt-container-fixed">
            <div class="flex flex-wrap items-center lg:items-end justify-between gap-5 pb-7.5">
                <div class="flex flex-col justify-center gap-2">
                    ...
                    <div class="flex items-center gap-2 text-sm font-normal text-secondary-foreground">
                        Update country information, currency and timezone settings
                    </div>
                </div>
            ...
            <form action="{{ route('team.settings.countries.update', $country) }}" method="POST">
                @csrf
                @method('PUT')
                                ...
                                <div class="grid gap-5">
                                    ...
                                    <div class="flex flex-col gap-1">
                                        ...
                                        <div id="timezone-container">
                                            @if(old('timezones', $country->timezones))
                                                @foreach(old('timezones', $country->timezones) as $index => $timezone)
