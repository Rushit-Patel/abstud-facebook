...
<x-team.layout.app title="Create Education Level" :breadcrumbs="$breadcrumbs">
    <x-slot name="content">
        <div class="kt-container-fixed">
            <div class="flex flex-wrap items-center lg:items-end justify-between gap-5 pb-7.5">
                <div class="flex flex-col justify-center gap-2">
                    ...
                    <div class="flex items-center gap-2 text-sm font-normal text-secondary-foreground">
                        Add a new education-level to the system
                    </div>
                </div>
            ...
            <x-team.card title="Education Level Information" headerClass="">
                <form action="{{ route('team.settings.education-level.store') }}" method="POST" class="form">
                    @csrf
                                    ...
                                    <div class="flex flex-col gap-1 mt-4">
                                        ...
                                        <label class="kt-label">
                                            ...
                                            <span class="kt-checkbox-label">
                                                Uncheck to make this education-level inactive
                                            </span>
                                        </label>
                                    </div>
                                </x-team.card>
                        ...
                        <div class="col-span-1">
                            <div class="grid gap-5 lg:gap-7.5">
                                ...
                                <x-team.card title="Required Optional Check">
                                    <div class="flax flex-wrap items-center">
