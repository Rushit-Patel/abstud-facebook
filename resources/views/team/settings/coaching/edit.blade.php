...
$breadcrumbs = [
    ...
    ['title' => 'Coaching', 'url' => route('team.settings.coaching.index')],
    ['title' => 'Edit Coaching']
];
@endphp
        ...
        <div class="kt-container-fixed">
            <div class="flex flex-wrap items-center lg:items-end justify-between gap-5 pb-7.5">
                ...
                <div class="flex items-center gap-2.5">
                    <a href="{{ route('team.settings.coaching.index') }}" class="kt-btn kt-btn-secondary">
                ...
                <form action="{{ route('team.settings.coaching.update', $coaching) }}" method="POST" class="form">
                        ...
                        <div class="grid gap-5 lg:gap-7.5">
                            ...
                            <x-team.card title="Status Settings">
                                    <x-team.forms.input
                                        ...
                                        :value="old('priority', $coaching->priority)"
                                        required />

                                <div class="flex flex-col gap-1 mt-4">
                                    <label class="kt-form-label font-normal text-mono">Do you currently take this coaching?</label>
                                    <label class="kt-label">
                                        <input class="kt-checkbox kt-checkbox-sm"
                                            name="is_coaching"
                                            type="checkbox"
                                            value="1"
                                            {{ old('is_coaching', $coaching->is_coaching) ? 'checked' : '' }}
                                        />
                                        <span class="kt-checkbox-label">
                                            Check if you are taking this coaching
                                        </span>
                                    </label>
                                </div>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-5 py-5 border-t border-gray-200">
                        ...
                        <div class="flex flex-col gap-2.5">
                            ...
                            <div class="text-sm text-gray-700">
                                {{ $coaching->updated_at->format('M d, Y \a\t h:i A') }}
                            </div>
                        </div>
                    </div>
