    ...
    <x-slot name="content">
        <div class="kt-container-fixed mb-5">
            ...
            {{-- <x-team.card title="Lead Information" headerClass=""> --}}
                <form action="{{ route('team.lead.store') }}" method="POST" class="form" enctype="multipart/form-data">
                    @csrf
                    <x-team.card title="Personal Information" headerClass="">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-3 gap-5 py-5">
                            ...
                            <div class="col-span-1">
                                <div class="grid gap-5">
                                    <x-team.forms.input name="last_name" label="Last Name" type="text"
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-3 gap-5 py-5">
                            ...
                            <div class="col-span-1">
                                <div class="grid gap-5 relative">
                                    ...
                                    <button type="button" onclick="copyMobileToWhatsapp()"
                                        class="absolute px-2 bg-blue-500 text-white text-sm rounded hover:bg-blue-600" style="margin-left: 89px; margin-top: -3px;">
                                        Copy
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="col-span-1">
                                <div class="grid gap-5">
                                    <x-team.forms.input name="email_id" label="Email id" type="text"
                                        placeholder="Enter email " :value="old('email_id')" required />
                                </div>
                            </div>
                        </div>
                        <div class="grid grid-cols-1 lg:grid-cols-3 gap-5 py-5">
                            ...
                            <div class="col-span-1">
                                <div class="grid gap-5">
                                    <x-team.forms.select name="country_id" label="Country" :options="$countries"
                                        :selected="null" placeholder="Select Country" searchable="true" required />
                                </div>
                            </div>

                            <div class="col-span-1">
                                <div class="grid gap-5">
                                    <x-team.forms.select name="state_id" label="State/Province" :options="[]"
                                        :selected="null" placeholder="Select State" searchable="true" required />
                                </div>
                            </div>
                            <div class="col-span-1">
                                <div class="grid gap-5">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-1 gap-5 py-5">
                            <div class="col-span-1">
                                <div class="grid gap-5">
                                    <x-team.forms.textarea id="address" name="address" label="Address"
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-1 gap-5 py-5">
                            <div class="col-span-1">
                                <div class="grid gap-5">
                                    <x-team.forms.textarea id="genralRemarks" name="genral_remark" label="Genral Remarks"
                                        :value="old('genral_remark')" placeholder="Enter genral remarks" />
                                </div>
                            </div>
                        </div>
                    </x-team.card>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-1 gap-5 py-5">
                        <div class="lg:col-span-1" id="lead-statistics-container">
                            <x-team.lead.add-english-proficiency
