...
@endphp
<x-team.layout.app title="Add Coaching" :breadcrumbs="$breadcrumbs">
    <x-slot name="content">
        <div class="kt-container-fixed">
            ...
            <x-team.card title="Coaching Information" headerClass="">
                <form action="{{ route('team.coaching.update',$registerData->id) }}" method="POST" class="form" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
