...
<x-team.layout.app title="Create Task" :breadcrumbs="$breadcrumbs">
    <x-slot name="content">
        <div class="kt-container-fixed">
            ...
            <div class="flex flex-wrap items-center lg:items-end justify-between gap-5 pb-7.5">
                ...
                <div class="flex items-center gap-2.5">
                    <a href="{{ route('team.task.index') }}" class="kt-btn kt-btn-secondary">
            ...
            <form action="{{ route('team.task.store') }}" method="POST" id="taskForm" enctype="multipart/form-data">
                @csrf
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    ...
                                    <div>
                                        <x-team.forms.select
                                            ...
                                            name="status_id"
                                            :options="$statuses"
                                            :selected="old('status_id', collect($statuses)->first()->id ?? '')"
    ...
    @push('scripts')
        ...
        <script>
            ...
            function updateHiddenAttachmentFields() {
                ...
                console.log('Updating hidden fields:', uploadedFiles);
