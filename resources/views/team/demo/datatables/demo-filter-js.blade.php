...
$(document).ready(function() {
    var STORAGE_KEY = 'demo_filters';

    // Handle filter form submission
    $('#demoFilterForm').on('submit', function(e) {
        e.preventDefault();
        applyLeadFilters();
    ...
    function applyLeadFilters() {
        var $form = $('#demoFilterForm');
        var $applyBtn = $('button[type="submit"][form="demoFilterForm"]');
    ...
    window.resetDemoFilters = function() {
        var $form = $('#demoFilterForm');
    ...
    //updateDemoFiltersFromStorage();
    //window.resetDemoFilters();
    if (typeof updateDemoFiltersFromStorage === "function") {
        updateDemoFiltersFromStorage();
    } else {
        window.resetDemoFilters(); // Only one reload at start
    }
});
</script>
