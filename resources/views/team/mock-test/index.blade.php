    ...
    <x-slot name="content">
        ...
        <div class="flex flex-wrap items-center lg:items-end justify-between gap-5 pb-7.5">
                <div class="flex flex-col justify-center gap-2">
                    ...
                    <p class="text-sm text-gray-600">Manage Mock Test for today and overdue Coaching</p>
                </div>
                <div class="flex items-center gap-2.5">
                    <a href="{{ route('team.mock-test.create') }}" class="kt-btn kt-btn-primary">
                        <i class="ki-filled ki-plus"></i> Add Mock Test
                    </a>
                </div>
            </div>
...
<x-team.modals.delete-modal
    ...
    message="Are you sure you want to delete this mock-test Coaching? This action cannot be undone."
/>
