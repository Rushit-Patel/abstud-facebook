...
$(document).ready(function() {
    var STORAGE_KEY = 'coaching_filters';

    // Handle filter form submission
    $('#coachingFilterForm').on('submit', function(e) {
        e.preventDefault();
        applyLeadFilters();
    ...
    $(document).on('click', '#clearAllFilters', function(e) {
        e.preventDefault();
        window.resetCoachingFilters();
    });

    function applyLeadFilters() {
        var $form = $('#coachingFilterForm');
        var $applyBtn = $('button[type="submit"][form="coachingFilterForm"]');
        ...
        table.ajax.reload(function() {
            ...
            var $drawer = $('#coaching_filter_drawer');
    ...
    window.resetCoachingFilters = function() {
        var $form = $('#coachingFilterForm');
    ...
    localStorage.removeItem(STORAGE_KEY);
    if (typeof updateCoachingFiltersFromStorage === "function") {
        updateCoachingFiltersFromStorage();
    } else {
        window.resetCoachingFilters(); // Only one reload at start
    }
});
</script>
