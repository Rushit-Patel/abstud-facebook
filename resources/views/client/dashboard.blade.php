            ...
            <div class="bg-white dark:bg-gray-800 shadow rounded-lg">
                ...
                <div class="px-6 py-4">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <h4 class="text-sm font-medium text-gray-500 dark:text-gray-400 mb-2">Student ID</h4>
                            <p class="text-gray-900 dark:text-white">{{ $student->student_id }}</p>
                        </div>
                        <div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-3">
                        <h3 class="text-lg font-medium text-blue-900 dark:text-blue-200">
                            Welcome to {{ $company->company_name ?? 'Student Portal' }}
                        </h3>
                        <p class="text-blue-700 dark:text-blue-300">
                            Your student portal is ready! Additional features will be available soon.
                        </p>
                    </div>
                </div>
            </div>
