...
{
    public function CoachingPending(PendingCoachingDataTable $PendingInvoiceDataTable)
    {
        $coaching_type = "Pending";
        return $PendingInvoiceDataTable->render('team.coaching.index',compact('coaching_type'));
    }
    ...
    public function CoachingDrop(DropCoachingDataTable $DropCoachingDataTable)
    {
        $coaching_type = "Drop";
        return $DropCoachingDataTable->render('team.coaching.index',compact('coaching_type'));
    }
    public function CoachingCompleted(CompletedCoachingDataTable $CompletedCoachingDataTable)
    {
        $coaching_type = "Completed";
        return $CompletedCoachingDataTable->render('team.coaching.index',compact('coaching_type'));
    }
    ...
    public function edit($id)
    {
        ...
        $faculty = User::where('branch_id',$registerData->clientLead->branch)->active()->get();
        $coachingM = CoachingMaterial::active()->get();

        return view('team.coaching.create', compact('registerData','coaching','coachingLength','faculty'));
    }
    // Invoice Create
