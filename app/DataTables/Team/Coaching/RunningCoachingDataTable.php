...
class RunningCoachingDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('exam_book', fn($row) => $this->renderExamBook($row))
            ...
            ->rawColumns(['action', 'client','coaching','exam_book','assign_owner'])
            ->setRowId('id');
    }

    private function renderAction($row): string
    {
        return view('team.coaching.datatables.other-action', ['id' => $row->id])->render();
    }
    ...
    private function renderExamBook($row): string
    {
        return view('team.coaching.datatables.exam-booking', [
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('exam_book')->title('Exam Book')->width(150)->searchable(true),
